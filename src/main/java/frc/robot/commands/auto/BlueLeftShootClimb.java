...
public class BlueLeftShootClimb extends LoggableSequentialCommandGroup{
    public BlueLeftShootClimb(SwerveSubsystem drivetrain, AutoFactory auto, ShooterSubsystem shooter, 
    ShootingState shootstate, ClimberSubsystem climber, HopperSubsystem hopper, FeederSubsystem feeder) {
        super(
                ...
                LoggableCommandWrapper.wrap(auto.resetOdometry("BlueLeftClimb")),
                new ClimberUp(climber),
                LoggableCommandWrapper.wrap(auto.trajectoryCmd("BlueLeftClimb")/*.withTimeout(n)*/), 
