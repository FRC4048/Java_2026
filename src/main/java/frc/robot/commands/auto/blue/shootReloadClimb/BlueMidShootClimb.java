package frc.robot.commands.auto.blue.shootReloadClimb;
...
public class BlueMidShootClimb extends LoggableSequentialCommandGroup{
    public BlueMidShootClimb(
        ...
        super(  
                new LoggableParallelCommandGroup( //done before the first pth bacause we are ideally shooting as we move during the BlueMid_OriginToTower
                    new SetTurretAngle(turret, 0),
                    new RunAnglerToReverseLimit(angler),
                    new SetShootingState(shootstate, ShootState.SHOOTING_HUB)
                ),
                LoggableCommandWrapper.wrap(auto.resetOdometry("BlueMid_OriginToTower")),
                new LoggableParallelCommandGroup(
                    LoggableCommandWrapper.wrap(auto.trajectoryCmd("BlueMid_OriginToTower").withTimeout(1.5)), //path = 1.3s
                ...
                LoggableCommandWrapper.wrap(auto.resetOdometry("BlueMid_TowardTower")),
                LoggableCommandWrapper.wrap(auto.trajectoryCmd("BlueMid_TowardTower")),
