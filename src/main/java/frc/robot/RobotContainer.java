    ...
    public void putShuffleboardCommands() {
        ...
        SmartDashboard.putData(
          ...
          */
            ...
            SmartDashboard.putData(
                    "Intake position 0",
                    new InstantCommand(() -> intakeSubsystem.setPosition(0.0), intakeSubsystem));

            SmartDashboard.putData(
                    "Intake position 10",
                    new InstantCommand(() -> intakeSubsystem.setPosition(10.0), intakeSubsystem));

            SmartDashboard.putData(
                    "Intake position 100",
                    new InstantCommand(() -> intakeSubsystem.setPosition(100.0), intakeSubsystem));
