...
public class SwerveSubsystem extends SubsystemBase {
     ...
     * it will replace whatever is defined in the JSON files. If null, will use the default implementation
     * from JSON.
     * This setup will allow for use of our special Gyro implementation (see {@link ThreadedGyro}) when running in real
     * mode, and to use the swerve-library internal SIM IMU when running in simulation - when the swerveImu passed
     * in is NULL.
     *
