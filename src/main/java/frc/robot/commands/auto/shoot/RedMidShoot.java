...
public class RedMidShoot extends LoggableSequentialCommandGroup{
    public RedMidShoot(
        ...
        super(  
                ...
                LoggableCommandWrapper.wrap(auto.resetOdometry("RedMidForward").withTimeout(3)),
                LoggableCommandWrapper.wrap(auto.trajectoryCmd("RedMidForward").withTimeout(3)), //path = 2.7s
                new LoggableParallelCommandGroup(
