...
public class RedDepotShootPickupClimb extends LoggableSequentialCommandGroup{
    public RedDepotShootPickupClimb(
        ...
        super(  
                ...
                LoggableCommandWrapper.wrap(auto.resetOdometry("RedDepot_Climb")),
                new LoggableParallelCommandGroup(
                    LoggableCommandWrapper.wrap(auto.trajectoryCmd("RedDepot_Climb").withTimeout(1.3)),
