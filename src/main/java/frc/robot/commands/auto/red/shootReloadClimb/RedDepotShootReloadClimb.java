...
public class RedDepotShootReloadClimb extends LoggableSequentialCommandGroup{
    public RedDepotShootReloadClimb(
        ...
        super(  
                ...
                new LoggableParallelCommandGroup(
                    LoggableCommandWrapper.wrap(auto.trajectoryCmd("RedLeftClimb").withTimeout(3)), //path = 2.7s
                    new SpinShooter(shooter, Constants.SHOOTER_SPEED),
                    new SpinHopper(hopper),
                    new SpinFeeder(feeder)
                ),
                LoggableCommandWrapper.wrap(auto.resetOdometry("RedDepot_DepotToTower")),
                LoggableCommandWrapper.wrap(auto.trajectoryCmd("RedDepot_DepotToTower")),
                new ClimberUp(climber),
                LoggableCommandWrapper.wrap(auto.resetOdometry("RedDepot_TowardTower")),
                LoggableCommandWrapper.wrap(auto.trajectoryCmd("RedDepot_TowardTower")),
